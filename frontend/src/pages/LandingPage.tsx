      ...
      <div className="lp-card">
        <div className="lp-logo">
          <svg width="28" height="28" viewBox="0 0 32 32" fill="none">
            <rect width="32" height="32" rx="8" fill="hsl(240, 65%, 55%)" />
            <path d="M8 10h16M8 16h12M8 22h10" stroke="white" strokeWidth="2.5" strokeLinecap="round" />
          </svg>
          <span className="lp-logo-name">Memocho</span>
        </div>

        <div className="lp-text">
          <h1 className="lp-title">Welcome back</h1>
          <p className="lp-sub">Sign in to continue to your notes and tasks.</p>
        </div>
